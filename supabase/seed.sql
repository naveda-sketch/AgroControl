...
INSERT INTO comprobante (id_comprobante, foto_url, ocr_proveedor, ocr_fecha, ocr_subtotal, ocr_iva, ocr_total, validado, sync_status) VALUES
    ('g1000000-0000-0000-0000-000000000001', 'https://storage.agrocontrol.app/tickets/001.jpg', 'Agroquímicos del Norte SA', '2026-03-10', 44100.00, 7056.00, 51156.00, true, 'sincronizado'),
    ('g1000000-0000-0000-0000-000000000002', 'https://storage.agrocontrol.app/tickets/002.jpg', 'Gasolinera Los Pinos', '2026-03-15', 43200.00, 6912.00, 50112.00, true, 'sincronizado'),
    ('g1000000-0000-0000-0000-000000000003', 'https://storage.agrocontrol.app/tickets/003.jpg', 'Semillas Nacionales SAPI', '2026-03-10', 256500.00, 41040.00, 297540.00, true, 'sincronizado');
...
INSERT INTO gasto (id_gasto, id_etapa, id_comprobante, concepto, monto, tipo, registrado_por, sync_id) VALUES
    -- Potrero Norte - Preparación
    ('h1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'g1000000-0000-0000-0000-000000000002', 'Diésel para rastreo', 28350.00, 'OPEX', 'a1000000-0000-0000-0000-000000000003', 'h1000000-0000-0000-0000-100000000001'),
    ('h1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', null, 'Jornales limpieza de terreno (5 días x 4 peones)', 18000.00, 'OPEX', 'a1000000-0000-0000-0000-000000000003', 'h1000000-0000-0000-0000-100000000002'),
    ('h1000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000001', 'g1000000-0000-0000-0000-000000000001', 'Herbicida pre-siembra (aplicación)', 13200.00, 'OPEX', 'a1000000-0000-0000-0000-000000000004', 'h1000000-0000-0000-0000-100000000003'),
    -- Potrero Sur - Preparación
    ('h1000000-0000-0000-0000-000000000004', 'd1000000-0000-0000-0000-000000000005', null, 'Diésel para rastreo', 25200.00, 'OPEX', 'a1000000-0000-0000-0000-000000000003', 'h1000000-0000-0000-0000-100000000004'),
    ('h1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000005', null, 'Jornales limpieza', 16000.00, 'OPEX', 'a1000000-0000-0000-0000-000000000004', 'h1000000-0000-0000-0000-100000000005'),
    -- Potrero Oriente - Preparación
    ('h1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000009', null, 'Diésel para rastreo', 22050.00, 'OPEX', 'a1000000-0000-0000-0000-000000000005', 'h1000000-0000-0000-0000-100000000006'),
    ('h1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000009', null, 'Jornales limpieza', 14000.00, 'OPEX', 'a1000000-0000-0000-0000-000000000005', 'h1000000-0000-0000-0000-100000000007');

-- ── Uso de equipo (CAPEX) ──
INSERT INTO uso_equipo (id_uso, id_equipo, id_etapa, horas_uso, hectareas_trabajadas, costo_calculado, fecha, operador) VALUES
    ('i1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 18.00, 45.00, 1275.00, '2026-03-16', 'a1000000-0000-0000-0000-000000000003'),
    ('i1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000001', 15.00, 45.00, 450.00, '2026-03-17', 'a1000000-0000-0000-0000-000000000003'),
    ('i1000000-0000-0000-0000-000000000003', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000005', 16.00, 40.00, 1133.33, '2026-03-21', 'a1000000-0000-0000-0000-000000000004');

-- ── Presupuesto Base ──
INSERT INTO presupuesto_base (id_budget, id_proyecto, etapa_tipo, concepto, monto_presupuestado) VALUES
    ('j1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'PREPARACION', 'Diésel y combustibles', 120000.00),
    ('j1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', 'PREPARACION', 'Mano de obra (jornales)', 72000.00),
    ('j1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000001', 'PREPARACION', 'Herbicida pre-siembra', 48000.00),
    ('j1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000001', 'SIEMBRA', 'Semilla', 360000.00),
    ('j1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000001', 'SIEMBRA', 'Fertilizante DAP', 300000.00),
    ('j1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000001', 'SIEMBRA', 'Mano de obra siembra', 60000.00),
    ('j1000000-0000-0000-0000-000000000007', 'b1000000-0000-0000-0000-000000000001', 'DESARROLLO', 'Fertilizante Urea', 200000.00),
    ('j1000000-0000-0000-0000-000000000008', 'b1000000-0000-0000-0000-000000000001', 'DESARROLLO', 'Insecticida', 96000.00),
    ('j1000000-0000-0000-0000-000000000009', 'b1000000-0000-0000-0000-000000000001', 'DESARROLLO', 'Riego y agua', 180000.00),
    ('j1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000001', 'COSECHA', 'Maquinaria cosecha', 360000.00),
    ('j1000000-0000-0000-0000-000000000011', 'b1000000-0000-0000-0000-000000000001', 'COSECHA', 'Flete y transporte', 180000.00),
    ('j1000000-0000-0000-0000-000000000012', 'b1000000-0000-0000-0000-000000000001', 'COSECHA', 'Mano de obra cosecha', 120000.00);
